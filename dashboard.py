...
with st.sidebar:
    ...
    st.write("""
    This visualization features two productivized  XGBoost and LSTM machine learning models trained on temperature data from Madrid's open data portal. Using Airflow, Python and Google Drive, new temperature predictions are generated every hour as new data becomes available from the Ayuntamiento de Madrid [Open Data Portal](https://datos.madrid.es/portal/site/egob/menuitem.c05c1f754a33a9fbe4b2e4b284f1a5a0/?vgnextoid=4985724ec1acd610VgnVCM1000001d4a900aRCRD&vgnextchannel=374512b9ace9f310VgnVCM100000171f5a0aRCRD&vgnextfmt=default). Its predictions are continuously compared with historical temperature records to provide pick the XGB/LSTM model used in the final productivized Temp Forecast App.
    """, unsafe_allow_html=True)

    st.write("""
    <div style="margin-top:10px;margin-bottom:20px;margin-left: auto;margin-right: auto;display:block;width:90%;"><a href="http://climadrid.com/"><img src="https://raw.githubusercontent.com/jbasurtod/streamlit_madrid_temperature_prediction/main/img/check_app_button.png" /></a></div>
             """, unsafe_allow_html=True)
